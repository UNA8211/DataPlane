...
## wrapper class for a FIFO queue of packets
class Interface:
...
class NetworkPacket:
    ...
    def __init__(self, dst_addr, data_S, src_addr):
    ...
    def from_byte_S(self, byte_S):
        ...
        return self(dst_addr, data_S, src_addr)
...
class Router:
    ...
    # @param routing_table: the routing table that the router will base forwarding decisions on
